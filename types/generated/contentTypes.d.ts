...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    ...
    date: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2024-12-16T12:00:00.000Z'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.DateTime &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2024-12-14T12:00:15.073Z'>;
...
export interface ApiHelpTypeHelpType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amount: Schema.Attribute.Text & Schema.Attribute.Required;
    applicant: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    paymentPeriod: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    requiredDocs: Schema.Attribute.Text & Schema.Attribute.Required;
    scope: Schema.Attribute.Text & Schema.Attribute.Required;
    typeOf: Schema.Attribute.Enumeration<
      [
        'Aile',
        'Bar\u0131nma-G\u0131da',
        'Engelli-Ya\u015Fl\u0131',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whoCanBenefit: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
